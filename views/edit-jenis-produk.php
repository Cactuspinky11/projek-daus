            ...
            <nav class="sb-sidenav accordion sb-sidenav-dark" id="sidenavAccordion">
                <div class="sb-sidenav-menu">
                    <div class="nav">
                        ...
                        <a class="nav-link" href="list-jenis-produk.php">
            ...
            <main>
                <div class="container-fluid px-4">
                    ...
                    <ol class="breadcrumb mb-4">
                        ...
                        <li class="breadcrumb-item"><a href="list-jenis-produk.php">Edit Jenis Produk</a></li>
                    ...
                    <div class="card mb-4">
                        ...
                        <div class="card-body">
                            <form action="edit-jenis-produk.php?id=<?= $jenis_produk['id'] ?>" method="POST">
                                <div class="mb-3">
                                    <label for="nama" class="form-label">Nama</label>
                                    <input type="text" class="form-control" id="nama"
                                        name="nama" value="<?= $jenis_produk['nama'] ?>" required>
                                </div>
                                <div class="mb-3">
                                    <label for="deskripsi" class="form-label">Deskripsi</label>
                                    <input type="text" class="form-control" id="deskripsi"
                                        name="deskripsi" value="<?= $jenis_produk['deskripsi'] ?>" required>
                                </div>

                                <a href="list-jenis-produk.php" class="btn btn-secondary"><i class="fas 
