                ...
                <main>
                    <div class="container-fluid px-4">
                        ...
                        <ol class="breadcrumb mb-4">
                            ...
                            <li class="breadcrumb-item"><a href="list-user.php">Detail Kartu Diskon</a></li>
                        ...
                        <div class="card mb-4">
                            ...
                            <div class="card-body">
                                ...
                                <div class="mt-3">
                                    ...
                                    <a href="edit-kartu-diskon.php?id=<?= $diskon['id'] ?>" class="btn btn-warning"><i class="fas 
                                    fa-edit"></i> Edit</a>
                                    <a href="delete-kartu-diskon.php?id=<?= $diskon['id'] ?>" class="btn btn-danger"><i class="fas 
                                    fa-trash"></i> Delete</a>
                                </div>
                            </div>
                        </div>
