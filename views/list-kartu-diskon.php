                                    ...
                                    <tbody>
                                        <?php foreach ($diskon as $index => $item) : ?>
                                            <tr>
                                                ...
                                                <td>
                                                    <a href="detail-kartu-diskon.php?id=<?= $item['id'] ?>" class="btn btn-primary">
                                                        <i class="fas fa-eye"></i> Detail
                                                    </a>

                                                    <a href="edit-kartu-diskon.php?id=<?= $item['id'] ?>" class="btn btn-warning">
                                                        <i class="fas fa-edit"></i> Edit
                                                    </a>

                                                    <a href="delete-kartu-diskon.php?id=<?= $item['id'] ?>" class="btn btn-danger" onClick="return confirm('Are you sure you want to delete this user?');">
