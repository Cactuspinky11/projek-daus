                ...
                <main>
                    <div class="container-fluid px-4">
                        ...
                        <ol class="breadcrumb mb-4">
                            ...
                            <li class="breadcrumb-item"><a href="list-anggota.php">User</a></li>
                        ...
                        <div class="card mb-4">
                            ...
                            <div class="card-body">
                                ...
                                <div class="mb-3">
                                        ...
                                        <div class="from-check form-chech-inline">
                                            <input type="radio" class="form-check-input" 
                                            name="status_aktif" id="" value="1">
                                            <label for="status_aktif" class="form-check-label">Aktif</label>
                                        </div>
                                        <div class="from-check form-chech-inline">
                                            <input type="radio" class="form-check-input" 
                                            name="status_aktif" id="" value="0">
                                            <label for="status_non_aktif" class="form-check-label">Non Aktif</label>
                                        </div>
                                    </div>
                                <div class="mb-3">
                                    <label for="kartu_diskon_id" class="form-label">Kartu Diskon</label>
                                    <select class="form-select" id="kartu_diskon_id" name="kartu_diskon_id" required>
                                        <option value="">-- Pilih Kartu Diskon --</option>
                                        <?php foreach ($diskonList as $diskon) : ?>
                                            <option value="<?= $diskon['id'] ?>"><?= htmlspecialchars($diskon['nama']) ?> - <?= $diskon['persen_diskon'] ?>%</option>
                                        <?php endforeach; ?>
                                    </select>
                                </div>
