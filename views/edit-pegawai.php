                ...
                <main>
                    <div class="container-fluid px-4">
                        ...
                        <ol class="breadcrumb mb-4">
                            ...
                            <li class="breadcrumb-item"><a href="list-user.php">Edit Pegawai</a></li>
                                ...
                                <form action="edit-pegawai.php?id=<?= $pegawai['id'] ?>"method="POST">
                                    ...
                                    <div class="mb-3">
                                        ...
                                        <div class="from-check form-chech-inline">
                                            ...
                                            name="jenis_kelamin" id="P" value="P" <?= $pegawai['jenis_kelamin'] === 'P' ? 'checked' : '' ?>> 
                                            <label for="perempuan" class="form-check-label">Perempuan</label>
                                        </div>
                                        <div class="from-check form-chech-inline">
                                            <input type="radio" class="form-check-input" name="jenis_kelamin" id="L" 
                                            value="L" <?= $pegawai['jenis_kelamin'] === 'L' ? 'checked' : '' ?>>
