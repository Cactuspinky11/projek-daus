            ...
            <main>
                <div class="container-fluid px-4">
                    ...
                    <ol class="breadcrumb mb-4">
                        ...
                        <li class="breadcrumb-item"><a href="list-pesanan.php">Edit Pesanan</a></li>
                            ...
                            <form action="edit-pesanan.php?id=<?= $pesanan['id'] ?>" method="POST">
                                <div class="mb-3">
                                    ...
                                    <input type="text" class="form-control" id="tanggal"
                                        name="tanggal" value="<?= $pesanan['tanggal'] ?>" required>
                                </div>
                                <div class="mb-3">
                                    <label for="diskon" class="form-label">Diskon</label>
                                    <input type="text" class="form-control" id="diskon"
                                        name="diskon" value="<?= $pesanan['diskon'] ?>" required>
                                </div>
                                <div class="mb-3">
                                    <label for="status_bayar" class="form-label">Status Bayar</label>
                                    <input type="text" class="form-control" id="status_bayar"
                                        name="status_bayar" value="<?= $pesanan['status_bayar'] ?>" required>
                                </div>

                                <a href="list-pesanan.php" class="btn btn-secondary"><i class="fas 
