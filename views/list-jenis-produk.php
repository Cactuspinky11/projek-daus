                ...
                <main>
                    <div class="container-fluid px-4">
                        ...
                        <ol class="breadcrumb mb-4">
                            ...
                            <li class="breadcrumb-item active">List Jenis Produk</li>
                        </ol>
                        <div class="card mb-4">
                                    ...
                                    <tbody>
                                        <?php foreach ($jenis_produk as $index => $item) : ?>
                                            <tr>
                                                ...
                                                <td>
                                                    <a href="detail-jenis-produk.php?id=<?= $item['id'] ?>" class="btn btn-primary">
                                                        <i class="fas fa-eye"></i> Detail
                                                    </a>

                                                    <a href="edit-jenis-produk.php?id=<?= $item['id'] ?>" class="btn btn-warning">
                                                        <i class="fas fa-edit"></i> Edit
                                                    </a>

                                                    <a href="delete-jenis-produk.php?id=<?= $item['id'] ?>" class="btn btn-danger" onClick="return confirm('Are you sure you want to delete this user?');">
