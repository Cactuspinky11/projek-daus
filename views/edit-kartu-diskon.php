                ...
                <main>
                    <div class="container-fluid px-4">
                        ...
                        <ol class="breadcrumb mb-4">
                            ...
                            <li class="breadcrumb-item"><a href="list-user.php">Edit Kartu Diskon</a></li>
                        ...
                        <div class="card mb-4">
                            ...
                            <div class="card-body">
                                <form action="edit-kartu-diskon.php?id=<?= $diskon['id'] ?>"method="POST">
                                    <div class="mb-3">
                                        <label for="nama" class="form-label">nama</label>
                                        <input type="text" class="form-control" id="nama" 
                                        name="nama" value="<?= $diskon['nama'] ?>" required>
                                    </div>
                                    <div class="mb-3">
                                        <label for="deskripsi" class="form-label">Deskripsi</label>
                                        <input type="text" class="form-control" id="deskripsi" 
                                        name="deskripsi" value="<?= $diskon['deskripsi'] ?>" required>
                                    </div>
                                    <div class="mb-3">
                                        <label for="persen_diskon" class="form-label">Persen Diskon</label>
                                        <input type="number" class="form-control" id="persen_diskon" 
                                        name="persen_diskon" value="<?= $diskon['persen_diskon'] ?>" required>
                                    </div>


                                    <a href="list-kartu-diskon.php" class="btn btn-secondary"><i class="fas 
