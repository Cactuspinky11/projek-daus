                ...
                <main>
                    <div class="container-fluid px-4">
                        ...
                        <ol class="breadcrumb mb-4">
                            ...
                            <li class="breadcrumb-item"><a href="list-detail-pesanan.php">Edit Detail Pesanan</a></li>
                            <li class="breadcrumb-item active">Edit Detail Pesanan</li>
                        </ol>
                        <div class="card mb-4">
                            ...
                            <div class="card-body">
                                <form action="edit-detail-pesanan.php?id=<?= $detail_pesanan['id'] ?>"method="POST">
                                    <div class="mb-3">
                                        <label for="pesanan_id" class="form-label">Pesanan Id</label>
                                        <input type="text" class="form-control" id="pesanan_id" 
                                        name="pesanan_id" value="<?= $detail_pesanan['pesanan_id'] ?>" required>
                                    </div>
                                    <div class="mb-3">
                                        <label for="produk_id" class="form-label">Produk Id</label>
                                        <input type="text" class="form-control" id="produk_id" 
                                        name="produk_id" value="<?= $detail_pesanan['produk_id'] ?>" required>
                                    </div>
                                    <div class="mb-3">
                                        <label for="jumlah" class="form-label">Jumlah</label>
                                        <input type="text" class="form-control" id="jumlah" 
                                        name="jumlah" value="<?= $detail_pesanan['jumlah'] ?>" required>
                                    </div>

                                    <a href="list-detail-pesanan.php" class="btn btn-secondary"><i class="fas 
                                    fa-arrow-left"></i> Back</a>
                                    <button type="submit" name="subamit" class="btn btn-warning"><i class="fa-solid fa-floppy-disk"></i></i> Update</button>
                                </form>
                            </div>
                        </div>
                    </div>
