                                    ...
                                    <tbody>
                                        <?php foreach ($pegawai as $index => $item) : ?>
                                            <tr>
                                                ...
                                                <td><?= $item ['jabatan'] ?></td>
                                                <td>
                                                    <a href="detail-pegawai.php?id=<?= $item['id'] ?>" class="btn btn-primary">
                                                        <i class="fas fa-eye"></i> Detail
                                                    </a>

                                                    <a href="edit-pegawai.php?id=<?= $item['id'] ?>" class="btn btn-warning">
                                                        <i class="fas fa-edit"></i> Edit
                                                    </a>

                                                    <a href="delete-pegawai.php?id=<?= $item['id'] ?>" class="btn btn-danger" onClick="return confirm('Are you sure you want to delete this user?');">
