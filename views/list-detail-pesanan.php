...
$detail_pesanan = DetailPesanan::get();
?>
        ...
        <main>
            <div class="container-fluid px-4">
                ...
                <ol class="breadcrumb mb-4">
                    ...
                    <li class="breadcrumb-item active">List Detai Pesanan</li>
                </ol>
                <div class="card mb-4">
                            ...
                            <tbody>
                                <?php foreach ($detail_pesanan as $index => $item) : ?>
                                    <tr>
                                        ...
                                        <td><?= $item['jumlah'] ?></td>
                                        <!-- <td>
                                            <a href="detail-detail-pesanan.php?id=<?= $item['id'] ?>" class="btn btn-primary">
                                                <i class="fas fa-eye"></i> Detail
                                            </a>

                                            <a href="edit-detail-pesanan.php?id=<?= $item['id'] ?>" class="btn btn-warning">
                                                <i class="fas fa-edit"></i> Edit
                                            </a>

                                            <a href="delete-detail-pesanan.php?id=<?= $item['id'] ?>" class="btn btn-danger" onClick="return confirm('Are you sure you want to delete this user?');">
