            ...
            <div id="layoutSidenav_content">
                <main>
                    <div class="container-fluid px-4">
                        <h1 class="mt-4">Detail Detail Pesanan</h1>
                        <ol class="breadcrumb mb-4">
                            <li class="breadcrumb-item"><a href="dashboard.php">Dashboard</a></li>
                            <li class="breadcrumb-item"><a href="list-detail-pesanan.php">Detail Detail Pesanan</a></li>
                            <li class="breadcrumb-item active">Detail Detail Pesanan</li>
                        </ol>
                        <div class="card mb-4">
                            ...
                            <div class="card-body">
                                <table class="table table-boarder">
                                    <tr>
                                        <th>Pesanan Id</th>
                                        <td><?= $detail_pesanan['pesanan_id'] ?></td>
                                    </tr>
                                    <tr>
                                        <th>Produk Id</th>
                                        <td><?= $detail_pesanan['produk_id'] ?></td>
                                    </tr>
                                    <tr>
                                        <th>Jumlah</th>
                                ...
                                <div class="mt-3">
                                    ...
                                    <a href="edit-detail-pesanan.php?id=<?= $detail_pesanan['id'] ?>" class="btn btn-warning"><i class="fas 
                                    fa-edit"></i> Edit</a>
                                    <a href="delete-detail-pesanan.php?id=<?= $detail_pesanan['id'] ?>" class="btn btn-danger"><i class="fas 
                                    fa-trash"></i> Delete</a>
                                </div>
                            </div>
                        </div>
