            ...
            <main>
                <div class="container-fluid px-4">
                    ...
                    <ol class="breadcrumb mb-4">
                        ...
                        <li class="breadcrumb-item"><a href="list-produk.php">User</a></li>
                    ...
                    <div class="card mb-4">
                        ...
                        <div class="card-body">
                            <form action="create-produk.php" method="POST">
                                <div class="mb-3">
                                ...
                                <div class="mb-3">
                                    ...
                                    <input type="text" class="form-control" id="harga_double"
                                        name="harga_double" required>
                                </div>
                                <div class="mb-3">
                                    <label for="stok" class="form-label">Stok</label>
                                    <input type="text" class="form-control" id="stok"
                                        name="stok" min="0" max="100" required>
                                </div>
                                <div class="mb-3">
                                    ...
                                    <select class="form-select" id="jenis_produk_id" name="jenis_produk_id" required>
                                        ...
                                        <?php foreach ($jenis_produk as $item) : ?>
                                            <option value="<?= $item['id'] ?>"><?= htmlspecialchars($item['nama']) ?></option>
                                        <?php endforeach; ?>
                                    </select>
                                </div>
